...
public class AdminMatchingListSelect extends AsyncTask<Void,Void,Void> {
    // 생성자
    ArrayList<MatchingDTO> myItemArrayList;
    AdminMatching_RV_Adapter adapter;

    public AdminMatchingListSelect(ArrayList<MatchingDTO> myItemArrayList, AdminMatching_RV_Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        String result = "";
        String postURL = ipConfig + "/app/anAdminMatchingList";
