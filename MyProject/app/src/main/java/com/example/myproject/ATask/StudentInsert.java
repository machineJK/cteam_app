...
public class StudentInsert extends AsyncTask<Void, Void, String> {
    String student_id,student_subject,student_grade,student_intro,student_image_path,student_addr,student_nickname;

    public StudentInsert(String student_id, String student_subject,
                         String student_grade, String student_intro,
                         String student_image_path,String student_addr, String student_nickname) {
